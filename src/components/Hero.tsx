...
export const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-dark pt-20">
      {/* Background Elements */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            delay: 0.3
              ...
              <Button asChild size="lg" className="bg-gradient-primary hover:opacity-90 text-primary-foreground font-semibold shadow-glow animate-glow-pulse px-8">
                <a href="https://wa.me/5500000000000" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-lg">
                  Peça seu orçamento no WhatsApp
                  <ArrowRight size={20} />
                </a>
              </Button>
              <Button asChild variant="outline" size="lg" className="border-border text-foreground hover:bg-card hover:text-primary">
                <a href="#servicos">
          ...
          delay: 0.3
            ...
            <div className="relative">
              ...
              <img src={heroImage} alt="Designer trabalhando em criação de sites" className="relative rounded-2xl shadow-2xl border border-border/50 w-full object-cover" />
            </div>
          </motion.div>
        </div>
      </div>
